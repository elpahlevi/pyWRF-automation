...
gfs_download_increment  = 1     # set to 1 if you want to download gfs dataset for every forecast hours
gfs_left_lon            = 90    # -180 to 180
gfs_right_lon           = 141   # -180 to 180
gfs_top_lat             = 8     # -90 to 90
gfs_bottom_lat          = -13   # -90 to 90
wrf_forecast_duration   = 1     # length of simulation days
wrf_num_proc            = 1     # number of CPU cores will be used to execute real.exe & wrf.exe
...
# Execute functions
utils.download_gfs(path = gfsout_path, start_date = start_date, issued_time = "00", forecast_time = gfs_forecast_time, increment = gfs_download_increment, left_lon = gfs_left_lon, right_lon = gfs_right_lon, top_lat = gfs_top_lat, bottom_lat = gfs_bottom_lat)
utils.download_gfs(path = gfsout_path, start_date = start_date, issued_time = "06", forecast_time = gfs_forecast_time, increment = gfs_download_increment, left_lon = gfs_left_lon, right_lon = gfs_right_lon, top_lat = gfs_top_lat, bottom_lat = gfs_bottom_lat)
utils.download_gfs(path = gfsout_path, start_date = start_date, issued_time = "12", forecast_time = gfs_forecast_time, increment = gfs_download_increment, left_lon = gfs_left_lon, right_lon = gfs_right_lon, top_lat = gfs_top_lat, bottom_lat = gfs_bottom_lat)
utils.download_gfs(path = gfsout_path, start_date = start_date, issued_time = "18", forecast_time = gfs_forecast_time, increment = gfs_download_increment, left_lon = gfs_left_lon, right_lon = gfs_right_lon, top_lat = gfs_top_lat, bottom_lat = gfs_bottom_lat)
...
utils.run_wrf(wps_path = wps_path, wrf_path = wrf_path, np = wrf_num_proc)
